...
g,gr,gw, g_old, g_new, gr_old, gw_old, gr_new, gw_new, g_expand, gr_expand, gw_expand, g_old_expand, g_new_expand, gr_old_expand, gw_old_expand, gr_new_expand, gw_new_expand=load(handel=r"svmr2_gr_expand_test.csv",old_handel=r"list of molecules used in Xiangue and Jesus paper.csv")
...
best_params_=([('C', 100), ('epsilon', 0.0001), ('kernel__k1__k1__constant_value', 244.6895930898557), ('kernel__k1__k2__length_scale', 58.553152039401134)])
trval,train,test,Train_MAE,Train_RMSE,Train_R,Train_RMSLE,MAE,RMSE,R,RMSLE,r_y_train_preds,r_y_test_preds=ml_model(data=gr_expand,C=best_params_[0][1],epsilon=best_params_[1][1],constant_value=best_params_[2][1],length_scale=best_params_[3][1],nu=3/2,features=['p1','p2','g1_lan_act','g2_lan_act','mu^(1/2)'],target='Re (\AA)',logtarget='Re (\AA)')


# In[ ]:


test_molecules=gr_expand[gr_expand['Molecule'].isin(['MoC','NbC','NiC','NiO','NiS','PbI','PdC','RuC','SnI','UO','WC','YC','ZnBr','ZnCl','WO','ZnI','ZnF','HCl','DCl','CrC','CoO','IrSi','UF','ZrC'])]['Molecule'].tolist()
true_values=gr_expand[gr_expand['Molecule'].isin(['MoC','NbC','NiC','NiO','NiS','PbI','PdC','RuC','SnI','UO','WC','YC','ZnBr','ZnCl','WO','ZnI','ZnF','HCl','DCl','CrC','CoO','IrSi','UF','ZrC'])]['Re (\AA)'].tolist()
re_test_preds=[]
re_test_std=[]
out=[]
s=0
...
testing_results.to_csv(r'svmr2_testing_results.csv')
