...
g,gr,gw, g_old, g_new, gr_old, gw_old, gr_new, gw_new, g_expand, gr_expand, gw_expand, g_old_expand, g_new_expand, gr_old_expand, gw_old_expand, gr_new_expand, gw_new_expand=load(handel=r"w2_gw_expand_pred.csv",old_handel=r"list of molecules used in Xiangue and Jesus paper.csv")
...
pyplot.savefig('w2_scatter.svg',bbox_inches=Bbox([[-1,-1],fig.get_size_inches()]))
...
pyplot.savefig('w2_scatter_ann.svg',bbox_inches=Bbox([[-1,-1],fig.get_size_inches()]))


# In[ ]:


results('Model w2',gw_expand,'omega_e (cm^{-1})',re_test_preds,308,MAE,RMSE,R,r"stat_summ.csv")
...
gw_expand.to_csv('w2_gw_expand_pred.csv')
